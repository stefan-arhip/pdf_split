        ...
        for page_num in range(len(pdf_reader.pages)):
            ...
            if 'Furnizor:' in text:
                ...
                if len(output_pdf.pages) > 0:
                    ...
                    if not os.path.isfile(f'{output_dir}/{output_filename}'):
                        with open(f'{output_dir}/{output_filename}', 'wb') as new_pdf:
                            # print('    Salvez prima pagina in fisierul: ',output_filename)                            
            ...
            if skip_file == 0:
                # print('    Adaug pagina noua la fisierul: ',output_filename)
